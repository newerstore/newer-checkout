...
module.exports = async function handler(req, res) {
  try {
    ...
    // shipping_lines.code = "melhorenvio_{service_id}" para o webhook do ME conseguir identificar o serviço
    ...
    const orderPayload = {
      order: {
        ...
        note_attributes: [
          ...
          { name: 'customer_cpf',       value: meta.customer_cpf || '' },          // ← CPF
        ...
        shipping_lines: [
          {
            ...
            code: shippingCode  // ← "melhorenvio_2" para o webhook do ME identificar o serviço
          }
        ],
